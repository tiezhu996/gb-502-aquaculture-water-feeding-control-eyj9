...
func main() {
	...
	feedConsumptionRepo := repository.NewFeedConsumptionRepository(db)
	...
	executionService := service.NewExecutionService(executionRepo, planRepo, pondRepo, readingRepo, feedBatchRepo, feedConsumptionRepo, auditService)
	feedBatchService := service.NewFeedBatchService(feedBatchRepo, feedConsumptionRepo, auditService)
	...
	handlers := router.Handlers{
		...
		FeedBatches: handler.NewFeedBatchHandler(feedBatchService),
