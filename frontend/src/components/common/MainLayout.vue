...
import { Collection, DataAnalysis, DocumentChecked, Fold, List, SwitchButton, Watermelon, Box } from '@element-plus/icons-vue'
...
const titles: Record<string, string> = {
  '/ponds': '养殖池工作台', '/readings': '水质读数', '/plans': '投喂计划', '/executions': '执行反馈', '/feed-batches': '饲料批次台账', '/audit': '操作审计',
}
  ...
  <div class="app-shell" :class="{ collapsed }">
    <aside class="sidebar">
      ...
      <nav class="main-nav" aria-label="主导航">
        ...
        <router-link to="/feed-batches"><Box /><span>饲料批次</span></router-link>
